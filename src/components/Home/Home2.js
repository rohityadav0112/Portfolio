...
function Home2() {
    return ( <
        ...
        i >
        <
        b className = "purple" > Python, Django, Fastapi and Javascript. < / b> < /
        i > <
        br / >
        <
        br / >
        ...
        for developing products with < b className = "purple" > Django < /b> and <
        i >
        <
        b className = "purple" > { " " }
        Modern Python Library and Frameworks Fastapi <
        /b> < /
        i > & drf; and like <
        i >
        <
